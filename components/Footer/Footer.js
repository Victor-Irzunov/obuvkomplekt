	...
	return (
		<footer className="footer footer-center p-10 bg-base-200 text-base-content rounded" id='contacts'>
			...
			<nav>
				...
				<div className='mt-4'>
					<a href='tel:' className='btn btn-neutral text-xl'>
						+375 29 000-00-00
					</a>
				</div>
				...
				<div className='mt-5 mb-0'>
					<p className='uppercase'>
						Всегда рады видеть Вас в качестве наших клиентов
					</p>
				</div>
			</nav>
			...
			<aside className='my-6'>
				<p className=''>
					Юр.адрес: Могилёвская обл., г. Бобруйск бульвар Приберезенский д.25 КВ.52
				</p>
				<p className=''>
					УНП 790657890
				</p>
				<p className=''>
					Свидетельство зарегистрировано администрацией Первомайского района г.Бобруйска сектор экономики 28.02.2022
				</p>
			</aside>
